...
![](/images/little_little_journalists.png "Small journalists")
...
![](/images/embedding.png "Genres of 'Forrest Gump' movie")
...
![](/images/question.png "How similar is 'Forrest Gump' to romantic and dramatic movies?")
...
![](/images/questionnaire.png "Questions are the rows of the Questionnaire Matrix")
...
![](/images/single_neuron.png "A single neuron is a Journalist asking a question-dot product")

Imagine you are given the following set of points (with classes orange and blue).

![](/images/scatter_plot.png "Points belonging to classes 'blue' and 'orange'")

For completeness the above scatter plot provided also as a line plot.

![](/images/line_plot.png "Line connecting the points above")
...
![](/images/trained_question.png "Question being asked to separate the classes of points = Similarity with green line")
...
![](/images/non-linearly-separable.png "The data cannot be distinguished ")
...
![](/images/neural_network.png "Neural network as a sequence of Journalists - Answers to the first Journalists are used as input to the next set of Journalists")
...
![](/images/relu.png "We want all our questions to be such that there is some similarity with the questions we ask for the questions to be significant and meaningful")
